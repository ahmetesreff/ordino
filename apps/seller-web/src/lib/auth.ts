const TOKEN_COOKIE = 'ordino_seller_token';
const USER_COOKIE = 'ordino_seller_user';
...
export function getUser(): { email: string; role: string; business?: { storeName: string; bizCode?: string } } | null {
  if (typeof document === 'undefined') return null;
